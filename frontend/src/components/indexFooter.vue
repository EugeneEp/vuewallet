...
export default {
  ...
  methods: {
  	getSms(e){
  		e.preventDefault();
  		const path = 'http://127.0.0.1:1337/sms';
  	...
  	smsCheck(e){
  		...
  		const path = 'http://127.0.0.1:1337/sms_check';
	    axios.post(path, this.smsForm)
	      .then((res) => {
  	...
  	regUser(e){
  		e.preventDefault();
  		const path = 'http://127.0.0.1:1337/registration';
  	...
  	logUser(e){
  		e.preventDefault();
  		const path = 'http://127.0.0.1:1337/login';
